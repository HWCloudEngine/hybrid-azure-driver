...
class AzureBackupDriver(driver.BackupDriver):
    ...
    def backup(self, backup, volume_file, backup_metadata=True):
        ...
        exists = self._check_exist(
            self.configuration.azure_volume_container_name,
            src_blob_name)
        if not exists:
    ...
    def restore(self, backup, volume_id, volume_file):
        ...
        exists = self._check_exist(
            self.configuration.azure_backup_container_name,
            src_blob_name)
        if not exists:
        ...
        self._copy_blob(self.configuration.azure_volume_container_name,
                        blob_name,
                        src_blob_uri)
