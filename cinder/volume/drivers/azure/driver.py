...
class AzureDriver(driver.VolumeDriver):
    ...
    def create_volume_from_snapshot(self, volume, snapshot):
        ...
        try:
            ...
            self._copy_disk(disk_name, snapshot_obj.id, volume['size'])
    ...
    def create_cloned_volume(self, volume, src_vref):
        ...
        try:
            ...
            self._copy_disk(disk_name, src_vref_obj.id, volume['size'])
    ...
    def clone_image(self, context, volume,
        ...
        try:
            ...
            self._copy_disk(disk_name, image_obj.id)
    ...
    def copy_volume_to_image(self, context, volume, image_service, image_meta):
        ...
        try:
            ...
            self._copy_disk(image_name, disk_obj.id)
            try:
                image_dict = {
                    'location': self.configuration.location,
                    'storage_profile': {
