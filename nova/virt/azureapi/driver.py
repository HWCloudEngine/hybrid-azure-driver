...
class AzureDriver(driver.ComputeDriver):
    ...
    def attach_volume(self, context, connection_info, instance, mountpoint,
        ...
        for i in range(1, 16):
            ...
            raise nova_ex.NovaException('Can not attach volume, exist volume'
                                        'amount upto 16.')
    ...
    def _cleanup_deleted_snapshots(self, context):
        ...
        try:
            ...
            LOG.info(_LI('Delete all residual snapshots in Azure'), i)
    ...
    def _cleanup_deleted_nics(self):
        ...
        try:
            try:
                ...
                ex = exception.NetworkInterfaceListFailure(
                    reason=six.text_type(e))
                raise ex
            ...
            for i in to_delete_ids:
                try:
                    ...
                    self.residual_nics = set(residual_ids) - i
